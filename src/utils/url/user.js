...
const pullLose = User + '/pullLose';//发表帖子 (post)      传参 为帖子实体类  后端用@RequestBody    接受
...
export { userInfo, User, updateINfo, seeList, pullLose, wantAdmin, selfPull, uploadurl, updatePull, deltePull }
